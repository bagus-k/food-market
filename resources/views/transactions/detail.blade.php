        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                <div class="flex flex-wrap -mx-4 -mb-4 md:mb-0">
                    ...
                    <div class="w-full md:w-5/6 px-4 mb-4 md:mb-5">
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="m-1/6">
                                ...
                                <div class="text-xl font-bold">{{ number_format( $item->status) }}</div>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-3">
                            <div class="m-2/6">
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'ON_DELIVERY']) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold px-2 rounded block text-center w-ful mb-1">
                                On Delivery
                            </a>
                            <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'DELIVERED']) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold px-2 rounded block text-center w-ful mb-1">
                                Delivered
                            </a>
                            <a href="{{ route('transactions.changeStatus', ['id' => $item->id, 'status' => 'CANCELLED']) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold px-2 rounded block text-center w-ful mb-1">
                                Cancelled
                            </a>
                            </div>
                        </div>
